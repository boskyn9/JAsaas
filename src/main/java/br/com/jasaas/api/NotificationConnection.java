...
public class NotificationConnection extends AsaasConnection<Notification, Object> {
    ...
    public NotificationConnection(AdapterConnection httpClient, EnvironmentAsaas environmentAsaas) {
        super(environmentAsaas, httpClient, EndpointEnum.NOTIFICATION);
    ...
    public List<Notification> getByCustomer(String customer_id) throws ConnectionException {
        String url = String.format("%s/%s", this.environmentAsaas.getEndpoint(), EndpointEnum.CUSTOMER_NOTIFICATION, customer_id);
